...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lw3/b;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_0

    invoke-static {}, Lw3/b;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, Lw3/b;->a:Ljava/lang/ClassLoader;
...
.method public static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lw3/b;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_1

    invoke-static {}, Lw3/b;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, Lw3/b;->b:Ljava/lang/Thread;
    ...
    :try_start_2
    sget-object v3, Lw3/b;->b:Ljava/lang/Thread;
...
.method public static declared-synchronized c()Ljava/lang/Thread;
    ...
    .line 11
    invoke-direct {v1, v8}, Lw3/a;-><init>(Ljava/lang/ThreadGroup;)V
    :try_end_3
