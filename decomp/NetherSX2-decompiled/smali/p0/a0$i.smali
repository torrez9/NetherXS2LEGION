...
.method public static b(Landroid/view/View;Lp0/m0;Landroid/graphics/Rect;)Lp0/m0;
    .locals 1
...
.method public static j(Landroid/view/View;)Lp0/m0;
    .locals 5

    .line 1
    sget-boolean v0, Lp0/m0$a;->d:Z
    ...
    .line 3
    :try_start_0
    sget-object v2, Lp0/m0$a;->a:Ljava/lang/reflect/Field;
    ...
    .line 4
    sget-object v2, Lp0/m0$a;->b:Ljava/lang/reflect/Field;
    ...
    .line 5
    sget-object v3, Lp0/m0$a;->c:Ljava/lang/reflect/Field;
    ...
    .line 7
    new-instance v3, Lp0/m0$d;

    invoke-direct {v3}, Lp0/m0$d;-><init>()V
    ...
    .line 8
    new-instance v3, Lp0/m0$c;

    invoke-direct {v3}, Lp0/m0$c;-><init>()V

    goto :goto_0

    .line 9
    :cond_2
    new-instance v3, Lp0/m0$b;

    invoke-direct {v3}, Lp0/m0$b;-><init>()V

    .line 10
    :goto_0
    invoke-static {v2}, Lg0/b;->c(Landroid/graphics/Rect;)Lg0/b;

    move-result-object v2

    .line 11
    invoke-virtual {v3, v2}, Lp0/m0$e;->c(Lg0/b;)V

    .line 12
    invoke-static {v0}, Lg0/b;->c(Landroid/graphics/Rect;)Lg0/b;

    move-result-object v0

    .line 13
    invoke-virtual {v3, v0}, Lp0/m0$e;->d(Lg0/b;)V

    .line 14
    invoke-virtual {v3}, Lp0/m0$e;->b()Lp0/m0;
...
.method public static u(Landroid/view/View;Lp0/q;)V
    .locals 2
    ...
    .line 5
    :cond_1
    new-instance v0, Lp0/a0$i$a;

    invoke-direct {v0, p0, p1}, Lp0/a0$i$a;-><init>(Landroid/view/View;Lp0/q;)V
