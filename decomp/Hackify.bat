...
:: --Fin de Limpieza del Manifest--


:: --Limpieza del Layout de Actividad Principal--
...
:: --Fin de Limpieza del Layout de Actividad Principal--


:: --Parchear Biblioteca Nativa--
:: Parchear verificaciones de firma
lib\hexalter 4248\lib\arm64-v8a\libemucore.so 0x838560=0x66,0x00,0x00,0x14 0x83B324=0x62,0x00,0x00,0x14
:: Parchear verificación de tipo de BIOS
...
:: Restaurar soporte para Launcher
...
:: --Fin de Parchear Biblioteca Nativa--
